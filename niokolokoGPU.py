...
# Set TensorFlow's verbosity to display detailed logs
...
model.fit(np.array(X_train), np.array(y_train), epochs=3, batch_size=16, validation_data=(np.array(X_test), np.array(y_test)), verbose=1)
